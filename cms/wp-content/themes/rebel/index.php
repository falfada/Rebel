    ...
    <section class="hero">
        <div class="container">
            <div class="d-flex position-relative">
                ...
                <?php if ($video_hero) : ?>
                    <div id="play-button-container" data-aos="slide-left" data-aos-delay="80" data-aos-duration="5000" class="showVideo video m-auto mt-64 col-5 col-md-12 position-md-relative position-absolute top right" data-video-url="<?= esc_url($video_hero['url']) ?>">
